...
/**
 * Servlet handling edition of existing albums
 *
 * @author Wojciech Francke
 * @version 2.0
 */
@WebServlet(name = "EditAlbum", urlPatterns = {"/EditAlbum"})
public class EditAlbumServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if(this.isInt(albumId) == false || this.isInt(releaseYearString) == false || "".equals(title) || "".equals(genre)) {
                ...
                if (em.find(Album.class, Long.parseLong(albumId)) == null) {
                    ...
                    album.setReleaseyear(Integer.parseInt(releaseYearString));
                    ...
                    out.println("<h1>Album " + album.getTitle() + " registered</h1>\n");
